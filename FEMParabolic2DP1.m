...
function [u,A] = FEMParabolic2DP1(Coordinates,Elements,C,B,Dirichlet,DirichletValue,Neumann,g,f,biotdisplacement,fVector,firstrun,Apre,Coefficients,GaussValues)
