...
Dirichletupre=[DirichletDown;DirichletRight;DirichletInnerEdgeUp;DirichletInnerEdgeRight;DirichletLeft];
...
%for  delta = [0.7:0.05:2.5,delta_opt]
    ...
    [p,Ap] = FEMParabolic2DP1(Coordinates,Elements,1/M+L,kappa*tau,Dirichletp,DirichletValue,Neumann,g,f_20,zeros(2*length(Coordinates(:,1)),1),1/M*p_0+L*p_0,1,0,Coefficients,GaussValues);
